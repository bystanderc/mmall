...
/**
 * Created by bystander on 2018/3/23.
 */
...
public class UserServiceImpl implements IUserService{
    ...
    @Override
    public ServerResponse<String> checkValid(java.lang.String str, java.lang.String type){
    ...
    public ServerResponse<String> resetPassword(String oldPassword, String newPassword, User user) {
        //防止横向越权，验证修改密码的就密码是指向这个客户，因为我们会查询一个count（1），如果不指定id，那么结果就是true
    ...
    public ServerResponse<User> updateInformation(User user) {
        ...
        if(resultCount > 0){
            ServerResponse.createByErrorMessage("email已经存在，请更换email再尝试更新");
        }
